...
function resizeCanvas3() {
  ...
  ctx4.fillText('FAQ Section', window.innerWidth * 0.1, canvas3.height * 0.1); // Customize text and position

  //text 2
  var textSize = Math.round(canvas4.width / 25);
  ctx4.font = textSize + 'px "Courier New", monospace'; // Customize as per your need
  ctx4.fillStyle = 'white'; // Text color
  ctx4.fillText("This site isn't", window.innerWidth * 0.1, canvas3.height * 0.30);
  ctx4.fillText("under construction.", window.innerWidth * 0.1, canvas3.height * 0.4);
  ctx4.fillText("It's for testing only.", window.innerWidth * 0.1, canvas3.height * 0.5);
